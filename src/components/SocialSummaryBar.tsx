...
const EMPTY: DashboardSummary = {
  ...
  direct_pending: 0, squad_pending: 0, organization_pending: 0,
...
export function SocialSummaryBar() {
  ...
  const pending = summary.direct_pending + summary.squad_pending + summary.organization_pending;
