...
export function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      const dashboard = (dashboardResult.data ?? {}) as { squad_contribution_points?: number; organization_contribution_points?: number; direct_pending?: number; squad_pending?: number; organization_pending?: number };
      setStats({
