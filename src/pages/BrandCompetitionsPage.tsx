...
export function BrandCompetitionsPage() {
  ...
  const save = async (event: FormEvent) => {
    ...
    if (!supabase || !orgId || !canManage || !verified) return;
