...
const DOCUMENTS: Record<LegalDocument, DocumentContent> = {
  terms: {
    ...
    sections: [
      ...
      { title: '5. DadoCoins, XP, Team Points y Gym Points', paragraphs: ['DadoCoins son puntos de fidelización internos y no constituyen dinero, depósito, título valor, criptoactivo ni saldo retirable. XP representa progresión; Team Points y Gym Points representan contribución competitiva dentro de sus respectivos contextos.', 'DadoFit puede aplicar límites, controles antifraude y reglas de elegibilidad para proteger la integridad de la economía de recompensas.'] },
